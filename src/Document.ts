...
export class Document {
    ...
    public syncExcerpt(syncInfo:ISourceSyncInfo, destInfo:IDestInfo):void {
        ...
        const markers = ExcerptUtil.excerptMarker(syncInfo.uri, syncInfo.rev, this.getCurrentRev())
    ...
    public takeExcerpt(offset:number, retain:number):ISourceInfo {
        ...
        const content = this.history.simulate([ExcerptUtil.take(offset, retain, length)], this.uri)
