...
import { expectEqual, transformPosition, JSONStringify, flattenDeltas, transformDeltas } from '../primitive/util';
...
describe("Quill Delta basic operations", () => {
    ...
    it("transformation of delta8 reordered", () => {
        ...
        expectEqual(transformDeltas(delta, target, false).ops, [{delete:2},{insert:"second"},{delete:2},{retain:5},{delete:4}])
    })
