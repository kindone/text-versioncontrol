...
describe("text spec regression", () => {
    it("case 1", () => {
        ...
        client1.applyChange(new Delta().retain(1, {"i":null}).retain(1).retain(1, {"b":null,"i":null}), "user1")
        client1.applyChange(new Delta().insert('haq').retain(2).delete(1).insert({"x":"nw"}), "user1")
        // console.log(JSONStringify(client1))

        const client2= SharedString.fromString(initial)
        client2.applyChange(new Delta().retain(1, {"i":null}).retain(1).retain(1, {"b":null,"i":null}), "user1")
        client2.applyChange(new Delta().insert('haq').retain(2).delete(1).insert({"x":"nw"}), "user1")
    ...
    it("case 2", () => {
        const initial = "a8j"
        const client1 = SharedString.fromString(initial)
        client1.applyChange(new Delta().delete(1).delete(1).delete(1), "user1")
        client1.applyChange(new Delta().insert({x:"fg"}).retain(1,{"b":null,"i":1}).retain(1).delete(1).insert("pvs", {"b":null}), "user2")
        // console.log(JSONStringify(client1))
        client1.applyChange(new Delta().insert('0m8').retain(2).retain(1, {"i":1}).insert({"y":"gq"}, {"b":null,"i":null}), "user1")
        // console.log(JSONStringify(client1))

        const client2= SharedString.fromString(initial)
        client2.applyChange(new Delta().delete(1).delete(1).delete(1), "user1")
        client2.applyChange(new Delta().insert('0m8').retain(2).retain(1, {"i":1}).insert({"y":"gq"}, {"b":null,"i":null}), "user1")
        // console.log(JSONStringify(client2))
        client2.applyChange(new Delta().insert({x:"fg"}).retain(1,{"b":null,"i":1}).retain(1).delete(1).insert("pvs", {"b":null}), "user2")
        // console.log(JSONStringify(client2))
    ...
    it("case 3", () => {
        ...
        // console.log(JSONStringify(client1))
        client1.applyChange(new Delta().insert("ykp").retain(1).insert({x:"47"}), "user2")
        // console.log(JSONStringify(client1))
        client1.applyChange(new Delta().delete(1).retain(3).retain(1), "user2")
        // console.log(JSONStringify(client1))
        client1.applyChange(new Delta().insert("c20").delete(3).retain(1), "user2")
        // console.log(JSONStringify(client1))
        client1.applyChange(new Delta().delete(1), "user1")
        // console.log(JSONStringify(client1))
        client1.applyChange(new Delta().insert({x:"y9"}).insert("i12"), "user1")
        // console.log(JSONStringify(client1))
        client1.applyChange(new Delta().insert({x:"lv"}).delete(3).delete(1), "user1")
        // console.log(JSONStringify(client1))
        ...
        // console.log(JSONStringify(client2))
        client2.applyChange(new Delta().insert({x:"lv"}).delete(3).delete(1), "user1")
        // console.log(JSONStringify(client2))
        client2.applyChange(new Delta().retain(1), "user1")
        // console.log(JSONStringify(client2))
        client2.applyChange(new Delta().insert("ykp").retain(1).insert({x:"47"}), "user2")
        // console.log(JSONStringify(client2))
        client2.applyChange(new Delta().delete(1).retain(3).retain(1), "user2")
        // console.log(JSONStringify(client2))
        client2.applyChange(new Delta().insert("c20").delete(3).retain(1), "user2")
        // console.log(JSONStringify(client2))
    ...
    it("case 4", () => {
        ...
        const delta4 = client1.applyChange(new Delta().insert("tia").delete(1).insert({x:"l2"}), "user1")
    ...
    it("case 5", () => {
        ...
        const delta2 = client1.applyChange(new Delta().insert("w7j").delete(2).insert({x:"xd"}).delete(1).insert({y:"kv"}).retain(1).insert({x:"ne"}), "user2")
        const delta3 = client1.applyChange(new Delta().retain(1), "user1")
        const delta4 = client1.applyChange(new Delta().insert("jq4").delete(6).retain(1).insert("69a"), "user2")
    ...
    it("case 6", () => {
        ...
        deltas.push(client1.applyChange(new Delta().insert({y:"se"}).delete(1).insert({x:"1g"}), "user1"))
    ...
    it("case 7", () => {
        ...
        const client1 = SharedString.fromString(initial)
        const deltas:IDelta[] = []
        deltas.push(client1.applyChange(new Delta().insert("u4t").delete(2).delete(1).delete(1).delete(1), "user2"))
        deltas.push(client1.applyChange(new Delta().insert("29l").retain(1).delete(1).retain(1), "user2"))
        deltas.push(client1.applyChange(new Delta().insert({"y":"7a"}).delete(1).delete(1).delete(1).insert("etw").delete(1).retain(1).insert({"x":"m4"}), "user1"))
