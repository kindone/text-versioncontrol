...
describe("Range", () => {
    it("applyChange", () => {
        ...
        expectEqual(range.applyChange(new Delta().retain(5).delete(15).insert('12345')), new Range(10,10)) // * delete reordered
        expectEqual(range.applyChange(new Delta([{retain:5}, {delete:15}, {insert:'12345'}])), new Range(5,5))
        expectEqual(range.applyChangeOpen(new Delta().retain(5).delete(15).insert('12345')), new Range(10,10)) // * delete reordered
        expectEqual(range.applyChangeOpen(new Delta([{retain:5}, {delete:15}, {insert:'12345'}])), new Range(5,10))
    })
    ...
    it("cropChange", () => {
        ...
        expectEqual(range.cropChangeOpen(new Delta([{retain:10}, {delete:1}, {insert:'123'}])), new Delta([{delete:1}, {insert:'123'}]))
        ...
        expectEqual(range.cropChangeOpen(new Delta().retain(10).delete(1).retain(1).insert('123')), new Delta().delete(1).retain(1).insert('123'))
        expectEqual(range.cropChangeOpen(new Delta().retain(10).delete(1).retain(1).insert('1234567890')), new Delta().delete(1).retain(1).insert('1234567890'))
        expectEqual(range.cropChangeOpen(new Delta().retain(10).delete(1).retain(1).insert('1234567890').delete(8)), new Delta().delete(1).retain(1).insert('1234567890').delete(8))
        expectEqual(range.cropChangeOpen(new Delta().retain(10).delete(1).retain(1).insert('1234567890').delete(9)), new Delta().delete(1).retain(1).insert('1234567890').delete(8))
        expectEqual(range.cropChangeOpen(new Delta().retain(10).delete(1).retain(1).insert('1234567890').retain(8).delete(1)), new Delta().delete(1).retain(1).insert('1234567890'))
        expectEqual(range.cropChangeOpen(new Delta().retain(1).insert('123').delete(1).retain(8).delete(1).retain(1).insert('1234567890').retain(8).delete(1)), new Delta().delete(1).retain(1).insert('1234567890'))
        expectEqual(range.cropChangeOpen(new Delta().retain(10).delete(1).retain(1).insert('1234567890').retain(7).delete(1).retain(1).delete(1)), new Delta().delete(1).retain(1).insert('1234567890').retain(7).delete(1))
    })
