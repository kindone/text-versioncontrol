...
describe('hand-made scenarios', () => {
    ...
    it('fragment iterator 1', () => {
        ...
        expectEqual(fragments.concat(iter.rest()), [
            { val: 'hell', mod: { insertedBy: 'me', deletedBy: ['me'] } },
    ...
    it('fragment tiebreak 1', () => {
        ...
        expectEqual(fragments, [
            { val: 'hello', mod: { insertedBy: 'me', deletedBy: [] } },
    ...
    it('fragment tiebreak 2', () => {
        ...
        expectEqual(fragments.concat(iter.rest()), [
            { val: ' world', mod: { insertedBy: 'me', deletedBy: [] } },
