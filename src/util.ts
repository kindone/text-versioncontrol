...
export function transformDeltas(delta1:IDelta, delta2:IDelta, laterWins:boolean)
{
...
{
    return flattenDeltas(delta1, transformDeltas(delta1, delta2, true))
}
